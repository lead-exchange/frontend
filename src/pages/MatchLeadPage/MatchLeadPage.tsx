...
const getActualCommissionValues = (match: Match): { leadCommission?: number } => {
  return {
    ...
    <>
      <div className={styles.container}>
        <div className={styles.content}>
          <ObjectMatchCard data={objectData as RealEstateObject} />
        ...
        {showControls && (
          <MatchControls
            onLike={() => {
              updateMatchAction(otherStatus === 'COMMISSION' ? 'ACCEPTED' : 'LIKED', leadCommission || match.leadCommission);
            }}
